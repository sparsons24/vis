...
var LDAvis = function(to_select, data_or_file_name) {
    ...
    var topic_select = to_select + "-cluster";
    ...
    var topicID = visID + "-cluster";
    var lambdaID = visID + "-lambda";
    var termID = visID + "-gene";
    ...
    function visualize(data) {
        ...
        //svg.append("text")
         //   .text("Intercluster Distance Map (via multidimensional scaling)")
        ...
        d3.select("#" + barFreqsID).append("text")
            ...
            .style("dominant-baseline", "middle")
            .text("Estimated gene frequency within the selected cluster");
        ...
        function init_forms(topicID, lambdaID, visID) {
            ...
            topicLabel.innerHTML = "Selected Cluster: <span id='" + topicID + "-value'></span>";
        ...
        function topic_on(circle) {
            ...
            d3.select("#" + barFreqsID)
                ...
                .style("text-anchor", "middle")
                .style("font-size", "16px")
                .text("Top-" + R + " Most Relevant Genes for Cluster " + topics + " (" + Freq + "% of tokens)");
        ...
        function term_on(term) {
            ...
            d3.select(to_select + " .circleGuideTitle")
                .text("Conditional cluster distribution given gene = '" + term.innerHTML + "'");
        }
